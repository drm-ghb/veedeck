...
export default async function MoodboardCanvasLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-dvh flex flex-col bg-muted/60">
      ...
      <div className="flex flex-1 min-h-0" style={{ backgroundColor: "var(--sidebar)" }}>
        ...
        />
        <main className="flex-1 overflow-hidden bg-background rounded-tl-2xl">
