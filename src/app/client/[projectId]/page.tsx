...
interface ListProduct {
  ...
  quantity: number; unit?: string; order: number; commentCount: number; approval: string | null; note: string | null; optional: boolean; parentProductId: string | null; orderStatus: string | null;
}
