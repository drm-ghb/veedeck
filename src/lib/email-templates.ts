...
<body style="margin:0;padding:0;background:#F5F5F5;">
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:#F5F5F5;font-size:1px;line-height:1px;">Zresetuj hasło do veedeck — link jest ważny przez 60 minut.</div>
                ...
                <tr>
                  <td class="vd-card-pad" style="padding:44px 48px;">
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 28px;">
                      <tr>
                        <td style="vertical-align:middle;padding-right:10px;"><img src="${ICON_URL}" width="20" height="20" alt="veedeck" style="display:block;width:20px;height:20px;border-radius:4px;"></td>
...
<body style="margin:0;padding:0;background:#F5F5F5;">
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:#F5F5F5;font-size:1px;line-height:1px;">Reset your veedeck password — this link is valid for 60 minutes.</div>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="vertical-align:middle;padding-right:10px;">
                    <img src="${ICON_URL}" width="20" height="20" alt="veedeck" style="display:block;width:20px;height:20px;border-radius:4px;">
                  </td>
...
<body style="margin:0;padding:0;background:#F5F5F5;">
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:#F5F5F5;font-size:1px;line-height:1px;">Masz zaproszenie do panelu projektanta veedeck. Kliknij, aby ustawić hasło i zacząć.</div>
...
<body style="margin:0;padding:0;background:#F5F5F5;">
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:#F5F5F5;font-size:1px;line-height:1px;">You have been invited to a designer's panel on veedeck. Click to set your password and get started.</div>
...
export function accessLinkContractorEmailPL({ link, personName, designerName }: { link: string; personName: string; designerName: string }): string {
  const safe = link.replace(/"/g, "&quot;");
  return `<!DOCTYPE html><html lang="pl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="color-scheme" content="light only"><meta name="supported-color-schemes" content="light only"><title>veedeck — panel wykonawcy</title><style>body{margin:0;padding:0;background:#F5F5F5;}a{color:#4F46E5;}a:hover{color:#4338CA;}@media(max-width:620px){.vd-card-pad{padding:32px 24px!important;}.vd-outer-pad{padding:24px 12px!important;}.vd-h1{font-size:26px!important;}}</style></head><body style="margin:0;padding:0;background:#F5F5F5;"><div style="display:none;max-height:0;overflow:hidden;opacity:0;color:#F5F5F5;font-size:1px;line-height:1px;">${designerName} udostępnił(a) Ci panel wykonawcy w veedeck. Kliknij, aby go otworzyć.</div><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#F5F5F5;"><tr><td align="center" class="vd-outer-pad" style="padding:40px 16px;font-family:'DM Sans',-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;"><table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;"><tr><td style="background:#FFFFFF;border:1px solid #E5E7EB;border-radius:18px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td class="vd-card-pad" style="padding:44px 48px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 28px;"><tr><td style="vertical-align:middle;padding-right:10px;"><img src="${ICON_URL}" width="20" height="20" alt="veedeck" style="display:block;width:20px;height:20px;border-radius:4px;"></td><td style="vertical-align:middle;line-height:1;font-family:'Nunito',Arial,sans-serif;font-size:19px;font-weight:300;letter-spacing:-0.05em;color:#24252B;">veedeck</td></tr></table><div style="font-family:'Inter',Arial,sans-serif;font-size:12px;font-weight:700;letter-spacing:0.09em;text-transform:uppercase;color:#8A8D9A;">Panel wykonawcy</div><h1 class="vd-h1" style="margin:10px 0 0;font-family:'Inter',Arial,sans-serif;font-size:30px;line-height:1.2;font-weight:700;letter-spacing:-0.025em;color:#24252B;">Cześć, ${personName}.</h1><p style="margin:16px 0 0;font-size:16px;line-height:1.6;color:#565A69;"><b style="color:#24252B;">${designerName}</b> udostępnił(a) Ci <b style="color:#24252B;">panel wykonawcy</b> w veedeck — znajdziesz tu foldery i pliki przekazane przez projektanta.</p><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:32px 0 0;"><tr><td style="border-radius:12px;background:#4F46E5;"><a href="${safe}" style="display:inline-block;padding:15px 30px;font-family:'DM Sans',Arial,sans-serif;font-size:15px;font-weight:600;color:#FFFFFF;text-decoration:none;border-radius:12px;">Otwórz panel wykonawcy</a></td></tr></table><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:32px 0 0;"><tr><td style="background:#F2F3F7;border-radius:14px;padding:22px 24px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding:0 0 10px;vertical-align:top;width:32px;font-size:16px;line-height:1;">🔗</td><td style="padding:0 0 10px;vertical-align:top;font-size:14px;line-height:1.6;color:#565A69;">Ten link jest <b style="color:#24252B;">stały i nie wygaśnie</b> — możesz z niego korzystać zawsze, gdy chcesz zalogować się do panelu.</td></tr><tr><td style="vertical-align:top;width:32px;font-size:16px;line-height:1;">🔑</td><td style="vertical-align:top;font-size:14px;line-height:1.6;color:#565A69;">Wolisz logować się hasłem? Ustaw je w panelu w ustawieniach konta, a następnie loguj się na <a href="https://veedeck.com/login" style="color:#4F46E5;text-decoration:underline;">veedeck.com/login</a>.</td></tr></table></td></tr></table><div style="border-top:1px solid #E5E7EB;margin:32px 0;"></div><p style="margin:0;font-size:13px;line-height:1.5;color:#8A8D9A;">Przycisk nie działa? Wklej ten link do przeglądarki:</p><p style="margin:10px 0 0;font-size:13px;line-height:1.6;word-break:break-all;"><a href="${safe}" style="color:#4F46E5;text-decoration:underline;">${link}</a></p><div style="border-top:1px solid #E5E7EB;margin:32px 0;"></div><p style="margin:0;font-size:13px;line-height:1.6;color:#A0A3AE;">Jeśli nie spodziewałeś(aś) się tej wiadomości, zignoruj ją.</p></td></tr></table></td></tr></table><tr><td style="padding:26px 24px 8px;text-align:center;"><p style="margin:0;font-size:13px;line-height:1.6;color:#8A8D9A;">veedeck - Visualize, Design, Deliver. Platforma dla projektantów wnętrz.</p><p style="margin:10px 0 0;font-size:13px;line-height:1.6;color:#A0A3AE;"><a href="https://veedeck.com/polityka-prywatnosci.html" style="color:#8A8D9A;text-decoration:none;">Polityka prywatności</a> · <a href="https://veedeck.com/polityka-cookies.html" style="color:#8A8D9A;text-decoration:none;">Cookies</a> · <a href="mailto:contact@veedeck.com" style="color:#8A8D9A;text-decoration:none;">contact@veedeck.com</a></p></td></tr></table></td></tr></table></body></html>`;
}
...
export function moodboardSharedClientEmailPL({ moodboardUrl, moodboardName, designerName, projectTitle }: {
  moodboardUrl: string;
  moodboardName: string;
  designerName: string;
  projectTitle: string;
}): string {
  const safe = moodboardUrl.replace(/"/g, "&quot;");
  return `<!DOCTYPE html>
<html lang="pl">
<head>
<meta charset="utf-8">
...
<meta name="color-scheme" content="light only">
<meta name="supported-color-schemes" content="light only">
<title>veedeck — tablica inspiracji</title>
<!--[if mso]><style>* { font-family: Arial, sans-serif !important; }</style><![endif]-->
<style>
  @import url('https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;600;700&family=Inter:wght@600;700&family=Nunito:wght@300&display=swap');
  body { margin: 0; padding: 0; background: #F5F5F5; }
...
<body style="margin:0;padding:0;background:#F5F5F5;">
  <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:#F5F5F5;font-size:1px;line-height:1px;">Projektant udostępnił Ci nowy moodboard. Kliknij, aby go zobaczyć.</div>
    ...
    <tr>
      <td align="center" class="vd-outer-pad" style="padding:40px 16px;font-family:'DM Sans',-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td class="vd-card-pad" style="padding:44px 48px;">
                    ...
                    <div style="font-family:'Inter',Arial,sans-serif;font-size:12px;font-weight:700;letter-spacing:0.09em;text-transform:uppercase;color:#8A8D9A;">Moodboard</div>
                    ...
                    <p style="margin:16px 0 0;font-size:16px;line-height:1.6;color:#565A69;">
                      <b style="color:#24252B;">${designerName}</b> udostępnił(a) Ci moodboard <b style="color:#24252B;">„${moodboardName}"</b> w&nbsp;projekcie <b style="color:#24252B;">${projectTitle}</b>.
                    </p>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:32px 0 0;">
                      <tr>
                        <td style="border-radius:12px;background:#4F46E5;">
                          <a href="${safe}" style="display:inline-block;padding:15px 30px;font-family:'DM Sans',Arial,sans-serif;font-size:15px;font-weight:600;color:#FFFFFF;text-decoration:none;border-radius:12px;">Przejdź do tablicy</a>
                        </td>
                      </tr>
                    </table>
                      ...
                      <tr>
                        <td style="background:#F2F3F7;border-radius:14px;padding:22px 24px;">
                          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td style="padding:0 0 10px;vertical-align:top;width:32px;font-size:16px;line-height:1;">🎨</td>
                              <td style="padding:0 0 10px;vertical-align:top;font-size:14px;line-height:1.6;color:#565A69;">W moodboardzie znajdziesz wizualne inspiracje dobrane przez projektanta do Twojego projektu — zdjęcia, kolory, materiały i&nbsp;układ wnętrza.</td>
                            </tr>
                            <tr>
                              <td style="vertical-align:top;width:32px;font-size:16px;line-height:1;">💬</td>
                              <td style="vertical-align:top;font-size:14px;line-height:1.6;color:#565A69;">Możesz przeglądać moodboard i&nbsp;omawiać go bezpośrednio z&nbsp;projektantem.</td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                    ...
                    <p style="margin:0;font-size:13px;line-height:1.5;color:#8A8D9A;">Przycisk nie działa? Wklej ten link do przeglądarki:</p>
                    <p style="margin:10px 0 0;font-size:13px;line-height:1.6;word-break:break-all;"><a href="${safe}" style="color:#4F46E5;text-decoration:underline;">${moodboardUrl}</a></p>
          ...
          <!-- Footer -->
          <tr>
            <td style="padding:24px 0 0;text-align:center;font-size:12px;color:#A0A3AE;font-family:'DM Sans',Arial,sans-serif;">
              © 2026 veedeck · <a href="https://veedeck.com" style="color:#A0A3AE;text-decoration:none;">veedeck.com</a>
            </td>
          </tr>
