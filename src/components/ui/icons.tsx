...
export const Stacks           = icon("stacks");
export const DeployedCode     = icon("deployed_code");
export const TextureIcon      = icon("texture");
export const AddShoppingCart  = icon("add_shopping_cart");
export const BookmarkAdd      = icon("bookmark_add");
...
export const Pipette          = icon("colorize");
...
export const AlignLeft        = icon("format_align_left");
export const AlignCenter      = icon("format_align_center");
export const AlignRight       = icon("format_align_right");
