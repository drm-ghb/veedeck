...
const TOTAL_STEPS = MODULE_COUNT + 1; // 0 = welcome, 1-12 = modules
...
export default function OnboardingModal({ show, userId }: { show: boolean; userId: string }) {
  ...
  const MODULE_STEPS: ModuleStepData[] = [
    ...
    { icon: LocalMall,    label: t.onboarding.listyLabel,      title: t.onboarding.listyTitle,      desc: t.onboarding.listyDesc,      steps: [t.onboarding.listyStep1, t.onboarding.listyStep2, t.onboarding.listyStep3], tip: t.onboarding.listyTip },
