...
const TYPE_CONFIG: Record<string, { icon: React.ReactNode; color: string }> = {
  ...
  render_accepted:  { icon: <Check size={14} />,         color: "text-green-600 bg-green-50 dark:bg-green-950/30" },
  render_rejected:  { icon: <X size={14} />,             color: "text-red-500 bg-red-50 dark:bg-red-950/30" },
